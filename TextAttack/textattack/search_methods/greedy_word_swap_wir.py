...
class GreedyWordSwapWIR(SearchMethod):
    ...
    Args:
        attack_method: method for ranking most important words
        model_wrapper: model wrapper used for gradient-based ranking
    """

    def __init__(self, wir_method="unk", unk_token="[UNK]", adv_train=False):
    ...
    def _get_index_order(self, initial_text):
        ...
        if self.wir_method == "unk":
            ...
            grad_output = victim_model.get_grad( \
                initial_text.tokenizer_input, adv_train=self.adv_train)                 # compute gradient for adversarial training or not.
