...
class A2TYoo2021(AttackRecipe):
    ...
    @staticmethod
    def build(model_wrapper, input_column_modification, args, adv_train=False, mlm=False):
        """Build attack recipe.

        Args:
            model_wrapper (:class:`~textattack.models.wrappers.ModelWrapper`):
                Model wrapper containing both the model and the tokenizer.
            adv_train (:obj:`bool`, `optional`, defaults to :obj:`False`):
                If :obj:`True`, `A2T` for adversarial training. Otherwise, just use this for adversarial example crafting.
        ...
        #
        search_method = GreedyWordSwapWIR(wir_method="gradient", adv_train=adv_train)
